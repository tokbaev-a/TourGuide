...
public class NatureFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        int[] images = {
                R.drawable.bali_jatiluwih_rice_terraces,
                R.drawable.bali_angels_billabong,
                R.drawable.bali_leke_leke,
                R.drawable.bali_beji_guwang,
                R.drawable.bali_desa_temukus,
                R.drawable.bali_kanto_lampo,
                R.drawable.bali_suluban_cave,
                R.drawable.bali_yeh_leh,
                R.drawable.bali_pasih_uug,
                        };
